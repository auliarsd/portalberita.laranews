                ...
                <div class="card">
                    ...
                    <div class="card-body px-4">
                        <form action="/dashboard/berita" method="POST" enctype="multipart/form-data">
                            ...
                            <img src="{{ asset('img/no-image.png') }}" class="tengah img-preview img-fluid mb-3 tengah" style="max-width: 280px; max-height: 280px;">
                            <div class="form-row">
                            ...
                            <trix-editor input="content" class="@error('description') border border-danger @enderror"></trix-editor>
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="date" name="post_date" value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
